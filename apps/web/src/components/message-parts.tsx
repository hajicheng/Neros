...
function Copy(props: SVGProps<SVGSVGElement>) {
  return (
    <IconBase {...props}>
      <path d="M16 4H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h9" />
...
function Package(props: SVGProps<SVGSVGElement>) {
  return (
    <IconBase {...props}>
      <path d="M16 16v5H8v-5" />
      <path d="M21 16v-7L12 2 3 9v7" />
      <path d="m16 7-4-2-4 2" />
      <path d="M3.27 6.96 12 12.01l8.73-5.05" />
    </IconBase>
  )
}

function Presentation(props: SVGProps<SVGSVGElement>) {
  return (
    <IconBase {...props}>
...
function Rocket(props: SVGProps<SVGSVGElement>) {
  return (
    <IconBase {...props}>
      <path d="M7 21 5 17 1 15 3 11 7 9 12 14 10 19s2 4 5 1c3-3 1-5 1-5l5-6-3-3-6 5-6-2-1 5 3 3-1 4z" />
    </IconBase>
  )
}
...
function Sparkles(props: SVGProps<SVGSVGElement>) {
  return (
    <IconBase {...props}>
      <path d="M12 3v3" />
      <path d="M12 18v3" />
      <path d="M4.22 4.22 6 6" />
      <path d="M18 18l1.78 1.78" />
      <path d="M3 12h3" />
      <path d="M18 12h3" />
      <path d="M4.22 19.78 6 18" />
      <path d="M18 6l1.78-1.78" />
    </IconBase>
  )
}

function Terminal(props: SVGProps<SVGSVGElement>) {
  return (
    <IconBase {...props}>
      <path d="M4 6h16" />
